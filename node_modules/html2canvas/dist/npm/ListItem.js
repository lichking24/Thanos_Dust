...
exports.createCounterText = exports.inlineListItemElement = exports.getListOwner = void 0;
...
var inlineListItemElement = function inlineListItemElement(node, container, resourceLoader) {
  ...
  if (text) {
    ...
    // $FlowFixMe
    container.childNodes.push(new _NodeContainer.default(wrapper, container, resourceLoader, 0));
  }
};

exports.inlineListItemElement = inlineListItemElement;
var ROMAN_UPPER = {
