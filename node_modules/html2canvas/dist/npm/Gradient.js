...
exports.transformWebkitRadialGradientArgs = exports.parseGradient = exports.RadialGradient = exports.LinearGradient = exports.RADIAL_GRADIENT_SHAPE = exports.GRADIENT_TYPE = void 0;
...
var _Length = _interopRequireWildcard(require("./Length"));
...
exports.GRADIENT_TYPE = GRADIENT_TYPE;
var RADIAL_GRADIENT_SHAPE = {
  CIRCLE: 0,
  ELLIPSE: 1
};
exports.RADIAL_GRADIENT_SHAPE = RADIAL_GRADIENT_SHAPE;
var LENGTH_FOR_POSITION = {
  left: new _Length.default('0%'),
  top: new _Length.default('0%'),
  center: new _Length.default('50%'),
  right: new _Length.default('100%'),
  bottom: new _Length.default('100%')
};
...
var parseColorStops = function parseColorStops(args, firstColorStopIndex, lineLength) {
  ...
  for (var i = firstColorStopIndex; i < args.length; i++) {
    ...
    var color = new _Color.default(HAS_LENGTH ? value.substring(0, lastSpaceIndex) : value);
    var stop = HAS_LENGTH ? new _Length.default(value.substring(lastSpaceIndex + 1)) : i === firstColorStopIndex ? new _Length.default('0%') : i === args.length - 1 ? new _Length.default('100%') : null;
    colorStops.push({
      color: color,
      stop: stop
    });
...
exports.transformWebkitRadialGradientArgs = transformWebkitRadialGradientArgs;
